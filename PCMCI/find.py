...
# temp = searchDF(pd.read_csv('D:/Eason Jin/NFL/PCMCI/temp_avg.csv'), [('time', 0)])
# df = searchDF(temp, [('team', 1), ('jerseyNumber', '!26')])
# df.to_csv('D:/Eason Jin/NFL/query.csv', index=False)